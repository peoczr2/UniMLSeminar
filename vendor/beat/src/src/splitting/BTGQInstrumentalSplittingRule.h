...
#ifndef GRF_BTGQINSTRUMENTALSPLITTINGRULE_H
#define GRF_BTGQINSTRUMENTALSPLITTINGRULE_H
...
class BTGQInstrumentalSplittingRule final: public SplittingRule {
public:
  BTGQInstrumentalSplittingRule(size_t max_num_unique_values,
                                uint min_node_size,
                                double alpha,
                                double imbalance_penalty);
  ~BTGQInstrumentalSplittingRule();
...
private:
  ...
  double alpha;
  double imbalance_penalty;
  DISALLOW_COPY_AND_ASSIGN(BTGQInstrumentalSplittingRule);
};

} // namespace grf

#endif // GRF_BTGQINSTRUMENTALSPLITTINGRULE_H
