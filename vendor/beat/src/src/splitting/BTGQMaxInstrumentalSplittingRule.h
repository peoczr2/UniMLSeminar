...
#ifndef GRF_BTGQMAXINSTRUMENTALSPLITTINGRULE_H
#define GRF_BTGQMAXINSTRUMENTALSPLITTINGRULE_H
...
class BTGQMaxInstrumentalSplittingRule final: public SplittingRule {
public:
  BTGQMaxInstrumentalSplittingRule(size_t max_num_unique_values,
                                   uint min_node_size,
                                   double alpha,
                                   double imbalance_penalty);
  ~BTGQMaxInstrumentalSplittingRule();
...
private:
  ...
  double alpha;
  double imbalance_penalty;
  DISALLOW_COPY_AND_ASSIGN(BTGQMaxInstrumentalSplittingRule);
};

} // namespace grf

#endif // GRF_BTGQMAXINSTRUMENTALSPLITTINGRULE_H
