...
// [[Rcpp::export]]
Rcpp::List btgq_max_causal_train(Rcpp::NumericMatrix train_matrix,
                                 ...
                                 unsigned int seed) {
  ForestTrainer trainer = btgq_max_instrumental_trainer(reduced_form_weight, stabilize_splits);
