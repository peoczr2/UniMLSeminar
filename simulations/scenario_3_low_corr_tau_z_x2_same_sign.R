run_scenario_3_low_corr_tau_z_x2_same_sign <- function(repo_root, output_dir, n_train, n_test, num_trees, beat_penalty, target_share, seed) {
  set.seed(seed)
  ...
  btgq_dumb_plot_path <- file.path(output_dir, sprintf("scenario_3_low_corr_tau_z_x2_same_sign_btgq_dumb_lambda_trace_seed_%s.png", seed))
  plot_btgq_lambda_trace(
